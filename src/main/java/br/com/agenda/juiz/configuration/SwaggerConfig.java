package br.com.agenda.juiz.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("br.com.agenda.juiz.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("Agenda de Compromissos - API").description("Projeto API Spring Rest")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/11Victor")
